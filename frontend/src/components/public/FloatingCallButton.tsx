...
export function FloatingCallButton() {
  ...
  const handleCall = () => {
    ...
    // ✅ Tip hatası yok: any + optional chaining
  ...
  const buttonContent = (
    ...
    >
      ...
      {/* Pulse rings */}
      <div className="absolute inset-0 rounded-full opacity-75 animate-ping" style={{ backgroundColor: "#14b8a6", pointerEvents: "none", zIndex: -1 }} />
      <div className="absolute inset-0 rounded-full opacity-50 animate-ping" style={{ backgroundColor: "#14b8a6", pointerEvents: "none", zIndex: -1 }} />
    </button>
  );
