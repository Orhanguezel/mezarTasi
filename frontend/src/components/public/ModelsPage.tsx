...
export function ModelsPage({ onNavigate, onProductDetail }: ModelsPageProps) {
  ...
  useEffect(() => {
    ...
    const handleProductUpdate = () => {
      console.log('🔄 ModelsPage - Product update event received');
    ...
    const handleForceRerender = () => {
      console.log('🔄 ModelsPage - Force rerender event received');
      setRefreshKey(prev => prev + 1);
      loadAllModels();
    };
    ...
    const handleStorageChange = () => {
      console.log('🔄 ModelsPage - Storage change event received');
      setRefreshKey(prev => prev + 1);
      loadAllModels();
    };
    ...
    const handleProductChange = (event: any) => {
      console.log('🔄 ModelsPage - Custom product change event received:', event.detail);
      setRefreshKey(prev => prev + 1);
      loadAllModels();
    };
